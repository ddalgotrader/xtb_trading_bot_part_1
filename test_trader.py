...
if __name__ == '__main__':
    ...
    xt=XtbTrader(client=client, ssid=ssid, instrument='EURUSD', interval='5min', lookback=1000, strategy=contrarian, units=0.1, end='2024-01-10 09:51', csv_results_path=<PATH_TO_SAVE_CSV_RESULTS>)
    while True:
